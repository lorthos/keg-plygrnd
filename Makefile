...
start_emr:
	@aws emr create-cluster --name "Powderkeg" --release-label emr-5.8.0  \
	...
	InstanceGroupType=CORE,InstanceCount=1,InstanceType=c4.2xlarge,BidPrice=0.12 --enable-debugging --log-uri s3://${S3_DEPLOY_BUCKET}/emr-logs \
